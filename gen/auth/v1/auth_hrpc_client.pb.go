...
func (client *HTTPAuthServiceClient) Federate(req *FederateRequest) (*FederateResponse, error) {
	...
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.Federate/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
...
func (client *HTTPAuthServiceClient) LoginFederated(req *LoginFederatedRequest) (*LoginFederatedResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.LoginFederated/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
...
func (client *HTTPAuthServiceClient) Key(req *KeyRequest) (*KeyResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.Key/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
...
func (client *HTTPAuthServiceClient) BeginAuth(req *BeginAuthRequest) (*BeginAuthResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.BeginAuth/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
...
func (client *HTTPAuthServiceClient) NextStep(req *NextStepRequest) (*NextStepResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.NextStep/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
...
func (client *HTTPAuthServiceClient) StepBack(req *StepBackRequest) (*StepBackResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.StepBack/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
...
func (client *HTTPAuthServiceClient) CheckLoggedIn(req *CheckLoggedInRequest) (*CheckLoggedInResponse, error) {
	...
	reader := bytes.NewReader(data)
	resp, err := client.Client.Post(client.BaseURL+"/protocol.auth.v1.AuthService.CheckLoggedIn/", "application/hrpc", reader)
	if err != nil {
		return nil, err
	}
	body, err := ioutil.ReadAll(resp.Body)
