...
type PreviewGuildResponse struct {
	...
	MemeberCount uint64 `protobuf:"varint,3,opt,name=memeber_count,json=memeberCount,proto3" json:"memeber_count,omitempty"`
}
...
func (x *PreviewGuildResponse) GetMemeberCount() uint64 {
	if x != nil {
		return x.MemeberCount
	}
	return 0
}
...
var file_chat_v1_guilds_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x49, 0x64, 0x22, 0x6b, 0x0a, 0x14, 0x50, 0x72, 0x65, 0x76,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x27, 0x0a, 0x0d,
	0x6d, 0x65, 0x6d, 0x65, 0x62, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x04, 0x42, 0x02, 0x30, 0x01, 0x52, 0x0c, 0x6d, 0x65, 0x6d, 0x65, 0x62, 0x65, 0x72,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x32, 0x0a, 0x11, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x47, 0x75,
	...
	0x52, 0x07, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x22, 0x5b, 0x0a, 0x1a, 0x41, 0x64, 0x64,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x1d, 0x0a, 0x1b, 0x41, 0x64, 0x64, 0x47, 0x75, 0x69,
	0x6c, 0x64, 0x54, 0x6f, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x60, 0x0a, 0x1f, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x47,
	...
	0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x22, 0x0a, 0x20, 0x52, 0x65, 0x6d, 0x6f, 0x76,
...
var file_chat_v1_guilds_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_chat_v1_guilds_proto_goTypes = []interface{}{
	...
	(*GetGuildListResponse_GuildListEntry)(nil), // 24: protocol.chat.v1.GetGuildListResponse.GuildListEntry
	(*GetGuildInvitesResponse_Invite)(nil),      // 25: protocol.chat.v1.GetGuildInvitesResponse.Invite
	(*v1.Metadata)(nil),                         // 26: protocol.harmonytypes.v1.Metadata
}
var file_chat_v1_guilds_proto_depIdxs = []int32{
	26, // 0: protocol.chat.v1.CreateGuildRequest.metadata:type_name -> protocol.harmonytypes.v1.Metadata
	24, // 1: protocol.chat.v1.GetGuildListResponse.guilds:type_name -> protocol.chat.v1.GetGuildListResponse.GuildListEntry
	26, // 2: protocol.chat.v1.GetGuildResponse.metadata:type_name -> protocol.harmonytypes.v1.Metadata
	25, // 3: protocol.chat.v1.GetGuildInvitesResponse.invites:type_name -> protocol.chat.v1.GetGuildInvitesResponse.Invite
	26, // 4: protocol.chat.v1.UpdateGuildInformationRequest.metadata:type_name -> protocol.harmonytypes.v1.Metadata
