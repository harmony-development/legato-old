...
var file_chat_v1_guilds_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x42, 0xbf, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x6f, 0x6c, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x47, 0x75, 0x69,
	0x6c, 0x64, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68,
	...
	0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x63, 0x68,
...
var file_chat_v1_guilds_proto_goTypes = []interface{}{
	(*Guild)(nil),                          // 0: protocol.chat.v1.Guild
	(*Invite)(nil),                         // 1: protocol.chat.v1.Invite
	(*InviteWithId)(nil),                   // 2: protocol.chat.v1.InviteWithId
	(*GuildListEntry)(nil),                 // 3: protocol.chat.v1.GuildListEntry
	(*CreateGuildRequest)(nil),             // 4: protocol.chat.v1.CreateGuildRequest
	(*CreateGuildResponse)(nil),            // 5: protocol.chat.v1.CreateGuildResponse
	(*CreateInviteRequest)(nil),            // 6: protocol.chat.v1.CreateInviteRequest
	(*CreateInviteResponse)(nil),           // 7: protocol.chat.v1.CreateInviteResponse
	(*GetGuildListRequest)(nil),            // 8: protocol.chat.v1.GetGuildListRequest
	(*GetGuildListResponse)(nil),           // 9: protocol.chat.v1.GetGuildListResponse
	(*GetGuildRequest)(nil),                // 10: protocol.chat.v1.GetGuildRequest
	(*GetGuildResponse)(nil),               // 11: protocol.chat.v1.GetGuildResponse
	(*GetGuildInvitesRequest)(nil),         // 12: protocol.chat.v1.GetGuildInvitesRequest
	(*GetGuildInvitesResponse)(nil),        // 13: protocol.chat.v1.GetGuildInvitesResponse
	(*GetGuildMembersRequest)(nil),         // 14: protocol.chat.v1.GetGuildMembersRequest
	(*GetGuildMembersResponse)(nil),        // 15: protocol.chat.v1.GetGuildMembersResponse
	(*UpdateGuildInformationRequest)(nil),  // 16: protocol.chat.v1.UpdateGuildInformationRequest
	(*UpdateGuildInformationResponse)(nil), // 17: protocol.chat.v1.UpdateGuildInformationResponse
	(*DeleteGuildRequest)(nil),             // 18: protocol.chat.v1.DeleteGuildRequest
	(*DeleteGuildResponse)(nil),            // 19: protocol.chat.v1.DeleteGuildResponse
	(*DeleteInviteRequest)(nil),            // 20: protocol.chat.v1.DeleteInviteRequest
	(*DeleteInviteResponse)(nil),           // 21: protocol.chat.v1.DeleteInviteResponse
	(*JoinGuildRequest)(nil),               // 22: protocol.chat.v1.JoinGuildRequest
	(*JoinGuildResponse)(nil),              // 23: protocol.chat.v1.JoinGuildResponse
	(*PreviewGuildRequest)(nil),            // 24: protocol.chat.v1.PreviewGuildRequest
	(*PreviewGuildResponse)(nil),           // 25: protocol.chat.v1.PreviewGuildResponse
	(*LeaveGuildRequest)(nil),              // 26: protocol.chat.v1.LeaveGuildRequest
	(*LeaveGuildResponse)(nil),             // 27: protocol.chat.v1.LeaveGuildResponse
	(*BanUserRequest)(nil),                 // 28: protocol.chat.v1.BanUserRequest
	(*BanUserResponse)(nil),                // 29: protocol.chat.v1.BanUserResponse
	(*KickUserRequest)(nil),                // 30: protocol.chat.v1.KickUserRequest
	(*KickUserResponse)(nil),               // 31: protocol.chat.v1.KickUserResponse
	(*UnbanUserRequest)(nil),               // 32: protocol.chat.v1.UnbanUserRequest
	(*UnbanUserResponse)(nil),              // 33: protocol.chat.v1.UnbanUserResponse
	(*v1.Metadata)(nil),                    // 34: protocol.harmonytypes.v1.Metadata
}
var file_chat_v1_guilds_proto_depIdxs = []int32{
	34, // 0: protocol.chat.v1.Guild.metadata:type_name -> protocol.harmonytypes.v1.Metadata
	1,  // 1: protocol.chat.v1.InviteWithId.invite:type_name -> protocol.chat.v1.Invite
	34, // 2: protocol.chat.v1.CreateGuildRequest.metadata:type_name -> protocol.harmonytypes.v1.Metadata
	3,  // 3: protocol.chat.v1.GetGuildListResponse.guilds:type_name -> protocol.chat.v1.GuildListEntry
	0,  // 4: protocol.chat.v1.GetGuildResponse.guild:type_name -> protocol.chat.v1.Guild
	2,  // 5: protocol.chat.v1.GetGuildInvitesResponse.invites:type_name -> protocol.chat.v1.InviteWithId
	34, // 6: protocol.chat.v1.UpdateGuildInformationRequest.new_metadata:type_name -> protocol.harmonytypes.v1.Metadata
