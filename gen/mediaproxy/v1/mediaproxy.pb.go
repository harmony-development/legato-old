...
type MediaProxyServiceClient interface {
	...
	CanInstantView(ctx context.Context, in *InstantViewRequest, opts ...grpc.CallOption) (*CanInstantViewResponse, error)
}
...
func (c *mediaProxyServiceClient) CanInstantView(ctx context.Context, in *InstantViewRequest, opts ...grpc.CallOption) (*CanInstantViewResponse, error) {
	out := new(CanInstantViewResponse)
	err := c.cc.Invoke(ctx, "/protocol.mediaproxy.v1.MediaProxyService/CanInstantView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMediaProxyServiceServer) CanInstantView(context.Context, *InstantViewRequest) (*CanInstantViewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CanInstantView not implemented")
}
...
func _MediaProxyService_CanInstantView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InstantViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaProxyServiceServer).CanInstantView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.mediaproxy.v1.MediaProxyService/CanInstantView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaProxyServiceServer).CanInstantView(ctx, req.(*InstantViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MediaProxyService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MediaProxyService_CanInstantView_Handler,
		},
	},
