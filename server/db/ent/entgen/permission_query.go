...
func (pq *PermissionQuery) sqlAll(ctx context.Context) ([]*Permission, error) {
	...
	if query := pq.withRole; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "role_permission" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (pgb *PermissionGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: PermissionGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PermissionGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PermissionGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: PermissionGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PermissionGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PermissionGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: PermissionGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PermissionGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PermissionGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: PermissionGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PermissionGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PermissionSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: PermissionSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PermissionSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PermissionSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: PermissionSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PermissionSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PermissionSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: PermissionSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PermissionSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PermissionSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: PermissionSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PermissionSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{permission.Label}
	default:
		err = fmt.Errorf("entgen: PermissionSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
