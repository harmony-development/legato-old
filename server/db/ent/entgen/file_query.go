...
func (fgb *FileGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(fgb.fields) > 1 {
		return nil, errors.New("entgen: FileGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := fgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fgb *FileGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (fgb *FileGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(fgb.fields) > 1 {
		return nil, errors.New("entgen: FileGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := fgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fgb *FileGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (fgb *FileGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(fgb.fields) > 1 {
		return nil, errors.New("entgen: FileGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := fgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fgb *FileGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (fgb *FileGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(fgb.fields) > 1 {
		return nil, errors.New("entgen: FileGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := fgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fgb *FileGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (fs *FileSelect) Strings(ctx context.Context) ([]string, error) {
	if len(fs.fields) > 1 {
		return nil, errors.New("entgen: FileSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := fs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fs *FileSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (fs *FileSelect) Ints(ctx context.Context) ([]int, error) {
	if len(fs.fields) > 1 {
		return nil, errors.New("entgen: FileSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := fs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fs *FileSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (fs *FileSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(fs.fields) > 1 {
		return nil, errors.New("entgen: FileSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := fs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fs *FileSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (fs *FileSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(fs.fields) > 1 {
		return nil, errors.New("entgen: FileSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := fs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (fs *FileSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{file.Label}
	default:
		err = fmt.Errorf("entgen: FileSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
