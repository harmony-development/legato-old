...
func (cq *ChannelQuery) QueryGuild() *GuildQuery {
	query := &GuildQuery{config: cq.config}
...
func (cq *ChannelQuery) QueryMessage() *MessageQuery {
...
// Returns a *NotSingularError when exactly one Channel entity is not found.
...
// Returns a *NotSingularError when exactly one Channel ID is not found.
...
func (cq *ChannelQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (cq *ChannelQuery) WithGuild(opts ...func(*GuildQuery)) *ChannelQuery {
	query := &GuildQuery{config: cq.config}
...
func (cq *ChannelQuery) WithMessage(opts ...func(*MessageQuery)) *ChannelQuery {
	query := &MessageQuery{config: cq.config}
	for _, opt := range opts {
		opt(query)
	}
...
//		Scan(ctx, &v)
//
func (cq *ChannelQuery) Select(field string, fields ...string) *ChannelSelect {
...
func (cq *ChannelQuery) sqlAll(ctx context.Context) ([]*Channel, error) {
	...
	if query := cq.withGuild; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "guild_channel" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := cq.withMessage; query != nil {
		...
		query.Where(predicate.Message(func(s *sql.Selector) {
			s.Where(sql.InValues(channel.MessageColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			fk := n.channel_message
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "channel_message" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
...
func (cq *ChannelQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	selector := builder.Select(t1.Columns(channel.Columns...)...).From(t1)
	if cq.sql != nil {
		selector = cq.sql
		selector.Select(selector.Columns(channel.Columns...)...)
	}
...
func (cgb *ChannelGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entgen: ChannelGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entgen: ChannelGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entgen: ChannelGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("entgen: ChannelGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entgen: ChannelSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entgen: ChannelSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entgen: ChannelSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("entgen: ChannelSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("entgen: ChannelSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) sqlQuery() sql.Querier {
	selector := cs.sql
