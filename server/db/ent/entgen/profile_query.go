...
func (pq *ProfileQuery) sqlAll(ctx context.Context) ([]*Profile, error) {
	...
	if query := pq.withUser; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "user_profile" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (pgb *ProfileGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProfileGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProfileGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProfileGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProfileGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProfileGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProfileGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProfileGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProfileGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *ProfileGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("entgen: ProfileGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *ProfileGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProfileSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProfileSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProfileSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProfileSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProfileSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProfileSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProfileSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProfileSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProfileSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *ProfileSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("entgen: ProfileSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *ProfileSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{profile.Label}
	default:
		err = fmt.Errorf("entgen: ProfileSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
