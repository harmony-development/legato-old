...
// QueryTextMessage chains the current query on the "text_message" edge.
...
// QueryFileMessage chains the current query on the "file_message" edge.
...
// the "text_message" edge. The optional arguments are used to configure the query builder of the edge.
...
// the "file_message" edge. The optional arguments are used to configure the query builder of the edge.
...
func (mq *MessageQuery) sqlAll(ctx context.Context) ([]*Message, error) {
	...
	if mq.withUser != nil || mq.withChannel != nil || mq.withParent != nil || mq.withFileMessage != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := mq.withUser; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "user_message" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := mq.withTextMessage; query != nil {
		...
		for _, n := range neighbors {
			fk := n.message_text_message
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "message_text_message" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "message_text_message" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := mq.withFileMessage; query != nil {
		...
		for i := range nodes {
			fk := nodes[i].message_file_message
			if fk != nil {
				ids = append(ids, *fk)
				nodeids[*fk] = append(nodeids[*fk], nodes[i])
			}
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "message_file_message" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := mq.withEmbedMessage; query != nil {
		...
		query.withFKs = true
		query.Where(predicate.EmbedMessage(func(s *sql.Selector) {
			s.Where(sql.InValues(message.EmbedMessageColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			fk := n.message_embed_message
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "message_embed_message" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "message_embed_message" returned %v for node %v`, *fk, n.ID)
			}
			node.Edges.EmbedMessage = n
		}
	}
...
func (mgb *MessageGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entgen: MessageGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entgen: MessageGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entgen: MessageGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MessageGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(mgb.fields) > 1 {
		return nil, errors.New("entgen: MessageGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := mgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mgb *MessageGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entgen: MessageSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entgen: MessageSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entgen: MessageSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MessageSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ms.fields) > 1 {
		return nil, errors.New("entgen: MessageSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ms.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ms *MessageSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{message.Label}
	default:
		err = fmt.Errorf("entgen: MessageSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
