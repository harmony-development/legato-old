...
func ID(id string) predicate.Emote {
...
func IDEQ(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func IDIn(ids ...string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func IDGTE(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func IDLT(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func IDLTE(id string) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
...
func HasEmotepack() predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EmotepackTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, EmotepackTable, EmotepackColumn),
		)
...
func HasEmotepackWith(preds ...predicate.EmotePack) predicate.Emote {
	return predicate.Emote(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
