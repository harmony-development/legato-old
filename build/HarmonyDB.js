...
var HarmonyDB = /** @class */ (function () {
    function HarmonyDB() {
        ...
        this.db.once('open', function () {
            console.log(chalk_1.default.green(chalk_1.default.bold('Successfully connected to MongoDB')));
        });
    }
    HarmonyDB.prototype.register = function (email, password, username) {
