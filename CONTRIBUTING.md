...
## Report bugs using Github's [issues](https://github.com/harmony-development/legato/issues)
...
We use `go fmt` to keep code style consistent and nice. Make sure to always run this before commiting! 
